...
.login-card {
  ...
  border-radius: 10px;
  box-shadow:
    0 30px 86px rgba(64, 45, 24, 0.18),
...
.brand-icon {
  ...
  border-radius: 20px;
  object-fit: cover;
  border: 1px solid rgba(175, 135, 68, 0.25);
  box-shadow: 0 16px 34px rgba(42, 30, 18, 0.16);
...
.form-group input:focus {
  ...
  box-shadow: 0 0 0 3px rgba(175, 135, 68, 0.14), inset 0 1px 0 rgba(255,255,255,0.6);
...
.submit-btn {
  ...
  border-radius: 8px;
  background: linear-gradient(180deg, #314b41, #223b32);
  color: #fff8e8;
  font-family: "Noto Serif SC", serif;
  font-size: 16px;
...
.submit-btn:hover:not(:disabled) {
  background: linear-gradient(180deg, #36554a, #1a2f28);
  transform: translateY(-2px);
